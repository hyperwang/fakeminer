...
class StratumClientProtocol(asyncio.Protocol):
    ...
    def stratum_send_submit(self, transport):
        ...
        self._stratum_send_request(transport, 'mining.submit', [self.worker_name, job_id, exn2, self.session.job.ntime, nounce])
...
miners = [
    ...
    ['Bixin', 'hyper', 's5', '123', (4.7, 'T')],
    ['Bixin', 'hyper', 's7', '123', (500, 'T')],
    ['Bixin', 'hyper', 's7', '123', (1, 'P')],
]*1000
